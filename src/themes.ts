...
export const THEMES: PedalTheme[] = [
  ...
  },
  {
    ...
    accent: '#4466ff',
    accentDark: '#3355cc',
    accentGlow: 'rgba(68, 102, 255, 0.5)',
    ledOff: '#111133',
    ledGradient: 'radial-gradient(circle at 40% 35%, #ffffff, #8899ff 40%, #4466ff 70%)',
    ledGlow: '0 0 8px #4466ff, 0 0 18px rgba(68, 102, 255, 0.7), 0 0 36px rgba(68, 102, 255, 0.4), 0 0 56px rgba(68, 102, 255, 0.15), inset 0 -1px 2px rgba(0, 0, 0, 0.15)',
  },
  {
    id: 'white',
    label: 'White',
