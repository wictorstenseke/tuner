...
export const THEMES: PedalTheme[] = [
  ...
  },
  {
    ...
    accent: '#4488ff',
    accentDark: '#3366cc',
    accentGlow: 'rgba(68, 136, 255, 0.5)',
    ledOff: '#0d1533',
    ledGradient: 'radial-gradient(circle at 40% 35%, #ffffff, #88aaff 40%, #4488ff 70%)',
    ledGlow: '0 0 8px #4488ff, 0 0 18px rgba(68, 136, 255, 0.7), 0 0 36px rgba(68, 136, 255, 0.4), 0 0 56px rgba(68, 136, 255, 0.15), inset 0 -1px 2px rgba(0, 0, 0, 0.15)',
  },
  {
    id: 'black',
    label: 'Black',
